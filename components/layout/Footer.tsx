...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0A0A08] text-taupe border-t border-white/[0.08] pt-16 sm:pt-20 pb-24 md:pb-16">
      <div className="max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-16 border-b border-white/[0.08]">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            >
              <span className="font-serif text-3xl tracking-wider text-cream font-medium leading-none group-hover:text-gold transition-colors">
                SHIRUI
              </span>
              <span className="text-[10px] tracking-[0.28em] text-taupe uppercase font-sans font-medium mt-1">
                Wellness Spa
              </span>
            </Link>
            ...
            <div className="flex items-center gap-3 pt-2">
              {businessConfig.instagramUrl && (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-white/[0.04] hover:bg-gold hover:text-obsidian flex items-center justify-center text-cream transition-colors border border-white/10"
                >
          ...
          <div className="lg:col-span-3 space-y-4">
            <span className="text-xs font-sans uppercase font-bold tracking-[0.2em] text-cream block">
              Explore
            </span>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm font-sans">
              <div>
                <span className="text-cream font-medium block">All 7 Days</span>
                <span className="text-taupe">10:00 AM – 9:30 PM</span>
              </div>
              <div>
                <span className="text-muted block text-[11px]">Last Entry</span>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-muted font-sans gap-4">
          ...
          <button
            type="button"
            onClick={scrollToTop}
            className="flex items-center gap-1 hover:text-gold transition-colors py-1 focus:outline-none"
